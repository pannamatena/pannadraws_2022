const imgData_2020 = {
  sandworts: {
    ...
    imgs: {
      full: {
        src: require('./sandworts_2020_web.jpg'),
        width: 714,
        height: 1000,
      },
      thumb: {
        src: require('./sandworts_2020_thumb.jpg'),
        width: 428,
        height: 600,
      },
    },
    year: '2020',
    description:
      'Ink and watercolour on watercolour paper. 210 x 297 mm, 2020.',
    price: 94,
    original: 'AVAILABLE',
    prints: 'NOTYET',
    printPrice: 0,
    ship: 'FREE_IRL',
    buyUrl: 'https://www.etsy.com/ie/listing/933507942/',
    printUrl: '',
    merch: [
      {
        name: 'Unisex t-shirt',
    ...
    discount: 0,
    discountPrint: 0,
    type: 'watercolour-painting',
    story:
      'This is the second of my spring collection prints: a pair of blue tits and an Irish wildflower, Sandworts. This painting was created as a t-shirt print, but postcards and greeting cards are also made with it!',
  },
  cuckooflowers: {
    title: 'Cuckooflowers',
    imgs: {
      full: {
        src: require('./cuckooflowers_2020_web.jpg'),
        width: 714,
        height: 1000,
      },
      thumb: {
        src: require('./cuckooflowers_2020_thumb.jpg'),
        width: 428,
        height: 600,
      },
    },
    year: '2020',
    description:
      'Ink and watercolour on watercolour paper. 297 x 420 mm, 2020.',
    price: 120,
    original: 'AVAILABLE',
    prints: 'NOTYET',
    printPrice: 0,
    ...
    type: 'watercolour-painting',
    story:
      'This is the first of my spring collection prints: a pair of grey herons in their courting dance, and some cuckooflowers to get that spring vibe going. Herons start courting in mid-February, taking on their party looks: bright orange beaks and fresh plumage.<br /><br />There are t-shirts, greeting cards and postcards available with this print!',
  },
  we_belong: {
    title: 'We Belong',
    imgs: {
      full: {
        src: require('./we_belong_2020_web.jpg'),
        width: 800,
        height: 1000,
      },
      thumb: {
        src: require('./we_belong_2020_thumb.jpg'),
        width: 480,
        height: 600,
      },
    },
    ...
    printPrice: 26.95,
    buyUrl: '',
    printUrl: 'https://www.etsy.com/ie/listing/925362562/',
    merch: [
      {
        name: 'Bookmark Set',
  ...
  muruchaill: {
    ...
    imgs: {
      full: {
        src: require('./muruchaill_2020_web.jpg'),
        width: 705,
        height: 1000,
      },
      thumb: {
        src: require('./muruchaill_2020_thumb.jpg'),
        width: 423,
        height: 600,
      },
    },
  ...
  jacks: {
    ...
    year: '2020',
    description:
      'Ink and watercolour on hot pressed watercolour paper. 400 x 570 mm, 2020.',
    price: 200,
    original: 'SOLD',
    prints: 'AVAILABLE',
    printPrice: 25.5,
    buyUrl: '',
    printUrl: 'https://www.etsy.com/ie/listing/923304031/',
    discount: 0,
    discountPrint: 0,
    type: 'watercolour-painting',
    story:
      'This artwork is mostly inspired by the magpies that visit my garden every day, but I also incorporated something from tropical natural history illustrations. The character of the birds really reminded me of an Irish tale, "Jack, the cunning thief". The hero of the story can steal anything from anywhere, and outsmarts everyone. Just like these rascals! Thieves they might be, but smart ones. I have to admit I do like magpies, even though I had my share of conflict with them!',
  },
  curlew: {
    title: 'Curlew',
    imgs: {
      full: {
        src: require('./curlew_2020_web.jpg'),
        width: 706,
        height: 1000,
      },
      thumb: {
        src: require('./curlew_2020_thumb.jpg'),
        width: 424,
        height: 600,
      },
    },
  ...
  alfalfa: {
    ...
    type: 'watercolour-painting',
    story:
      'This is a commissioned t-shirt print for <a href="https://www.instagram.com/max_border_collie27/" target="_blank" rel="noopener noreferrer">Max</a>, a blue merle border collie. The t-shirts are now available at <a href="https://pannadraws.etsy.com/" target="_blank" rel="noopener noreferrer">Etsy store</a>!',
  },
  lirs_daughter: {
    title: "Lir's Daughter (Feathers of Tales X)",
    imgs: {
      full: {
        src: require('./lirs_daughter_2020_web.jpg'),
        width: 798,
        height: 1000,
      },
      thumb: {
        src: require('./lirs_daughter_2020_thumb.jpg'),
        width: 479,
        height: 600,
      },
    },
    ...
    original: 'SOLD',
    prints: 'AVAILABLE',
    buyUrl: 'https://www.etsy.com/ie/listing/902422157/',
    printUrl: 'https://www.etsy.com/ie/listing/911737817/',
    printPrice: 26.95,
    merch: [
      {
        name: 'Bookmark Set',
  ...
  treasures: {
    ...
    year: '2020',
    description:
      'Ink and watercolour on mixed media paper. 297 x 420 mm ( 11.69 x 16.53 in), 2020.',
    price: 120,
    original: 'AVAILABLE',
    prints: 'SOLD',
    printPrice: 21.95,
    ship: 'FREE_IRL',
    buyUrl: 'https://www.etsy.com/ie/listing/896513203/',
    printUrl: 'https://www.etsy.com/ie/listing/889404732/',
    discount: 0,
    discountPrint: 0,
    type: 'watercolour-painting',
    story:
      "While drawing this I was so so tempted to move it towards a contemporary issue and add plastic waste among the seashells and logs. That would have been the reality, this in my painting is the fairy tale guys...<br /><br />I took the reference photo on Bull Island and on some days its shore is a disgrace. Plastic everywhere, bottles, scraps, all the little colourful bits that doesn't fit in the greyish green on the shore. Sad.<br /><br />So this piece is kept as an imaginary scene, a dream, without the rubbish, just the natural elements. A bit of comfort and escape from reality.",
  },
  christmas_tits_2020: {
    title: 'Christmas Tits 2020',
    imgs: {
      full: {
        src: require('./christmas_tits_2020_web.jpg'),
        width: 1500,
        height: 1499,
      },
      thumb: {
        src: require('./christmas_tits_2020_thumb.jpg'),
        width: 750,
        height: 750,
      },
    },
    year: '2020',
    description:
      'Ink and watercolour on watercolour paper. 210 x 297 mm (8.27 x 11.69 in), 2020.',
    price: 110,
    original: 'SOLD',
    prints: 'AVAILABLE',
    buyUrl: 'https://www.etsy.com/ie/listing/878489796/',
    merch: [
      {
        name: 'Christmas Cards (set of 3 or 6)',
        url: 'https://www.etsy.com/ie/listing/891942385/',
        price: 8,
        discount: 0,
      },
    ],
    printUrl: 'https://www.etsy.com/ie/listing/1022714495/',
    printPrice: 15.95,
    discount: 0,
    discountPrint: 0,
    type: 'watercolour-painting',
    story:
      'These little tits were painted to become prints for a set of Christmas greeting cards. The original paintings are a set of 3 paintings, while the cards can be bought in sets of 3 or 6 (together with the Robin cards). The 3 paintings picture two coal tits and a blue tit showcasing fantastic acrobatic skills!<br /><br />In the picture here you can see the set of holiday greeting cards, but if you head over to my shop (use the link below to the original) you can see the paintings in detail. The cards come with gold envelopes. The paintings are unframed, but mounted in 16 x 20" photo mounts and they fit in standard size frames.',
  },
  christmas_robins_2020: {
    title: 'Christmas Robins 2020',
    imgs: {
      full: {
        src: require('./christmas_robins_2020_web.jpg'),
        width: 1500,
        height: 1499,
      },
      thumb: {
        src: require('./christmas_robins_2020_thumb.jpg'),
        width: 750,
        height: 750,
      },
    },
    ...
    original: 'SOLD',
    prints: 'AVAILABLE',
    buyUrl: 'https://www.etsy.com/ie/listing/892422311/',
    printUrl: 'https://www.etsy.com/ie/listing/1008727456/',
    printPrice: 15.95,
    merch: [
      {
        name: 'Christmas Cards (set of 3 or 6)',
    ...
    type: 'watercolour-painting',
    story:
      'These handsome robins were painted to become prints for a set of Christmas greeting cards. The original paintings are a set of 3 paintings, while the cards can be bought in sets of 3 or 6 (together with the Tit cards). The 3 paintings picture the birds in different poses, all familiar to those who love these photogenic little birds.<br /><br />In the picture here you can see the set of holiday greeting cards, but if you head over to my shop (use the link below to the original) you can see the paintings in detail. The cards come with gold envelopes. The paintings are unframed, but mounted in 16 x 20" photo mounts and they fit in standard size frames.',
  },
  rascals: {
    title: 'Rascals',
    imgs: {
      full: {
        src: require('./rascals_2020_web.jpg'),
        width: 734,
        height: 1000,
      },
      thumb: {
        src: require('./rascals_2020_thumb.jpg'),
        width: 440,
        height: 600,
      },
    },
    year: '2020',
    description:
      'Ink and watercolour on watercolour paper. 297 x 420 mm ( 11.69 x 16.53 in), 2020.',
    price: 135,
    printPrice: 21.95,
    original: 'SOLD',
    prints: 'AVAILABLE',
    buyUrl: '',
    printUrl: 'https://www.etsy.com/ie/listing/870126360/',
    merch: [
      {
        name: "Artist's Sketchbook",
        url: 'https://www.etsy.com/ie/listing/888840913/',
        price: 23,
        discount: 0,
      },
      {
      ...
      {
        name: "Men's t-shirt",
        url: 'https://www.etsy.com/ie/listing/875381994/',
        price: 31.5,
        discount: 0,
      },
    ],
  ...
  st_colmans_duck: {
    ...
    imgs: {
      full: {
        src: require('./st_colmans_duck_2020_web.jpg'),
        width: 710,
        height: 1000,
      },
      thumb: {
        src: require('./st_colmans_duck_2020_thumb.jpg'),
        width: 426,
        height: 600,
      },
    },
    ...
    printUrl: 'https://www.etsy.com/ie/listing/889392704/',
    discount: 0,
    discountPrint: 0,
    type: 'watercolour-painting',
    story:
  ...
  may: {
    ...
    imgs: {
      full: {
        src: require('./may_2020_web.jpg'),
        width: 703,
        height: 1000,
      },
      thumb: {
        src: require('./may_2020_thumb.jpg'),
        width: 422,
        height: 600,
      },
    },
  ...
  furcula: {
    ...
    imgs: {
      full: {
        src: require('./furcula_2020_web.jpg'),
        width: 797,
        height: 1000,
      },
      thumb: {
        src: require('./furcula_2020_thumb.jpg'),
        width: 478,
        height: 600,
      },
    },
    ...
    printUrl: 'https://www.etsy.com/ie/listing/889399616/',
    discount: 0,
    discountPrint: 0,
    type: 'watercolour-painting',
    story:
  ...
  the_ousel_of_cilgwri: {
    ...
    imgs: {
      full: {
        src: require('./the_ousel_of_cilgwri_2020_web.jpg'),
        width: 711,
        height: 1000,
      },
      thumb: {
        src: require('./the_ousel_of_cilgwri_2020_thumb.jpg'),
        width: 427,
        height: 600,
      },
    },
  ...
  the_robin: {
    ...
    imgs: {
      full: {
        src: require('./the_robin_2020_web.jpg'),
        width: 708,
        height: 1000,
      },
      thumb: {
        src: require('./the_robin_2020_thumb.jpg'),
        width: 425,
        height: 600,
      },
    },
  ...
  sparrowhawk: {
    ...
    prints: 'AVAILABLE',
    buyUrl: '',
    printUrl: 'https://www.etsy.com/ie/listing/841725878/',
    discount: 0,
    discountPrint: 0,
    merch: [
      {
        name: "Artist's Notebook",
        url: 'https://www.etsy.com/ie/listing/911212429/',
        price: 20.95,
        discount: 0,
      },
      {
        name: 'Fridge Magnet',
        url: 'https://www.etsy.com/ie/listing/882191122/',
        price: 5.15,
        discount: 0,
      },
    ],
  ...
  the_fishermans_son: {
    ...
    prints: 'SOLD',
    ship: 'FREE_IRL',
    buyUrl: 'https://www.etsy.com/ie/listing/827929980/',
    printUrl: 'https://www.etsy.com/ie/listing/841722676/',
    discount: 0,
    discountPrint: 0,
    type: 'watercolour-painting',
    story:
  ...
  one_for_sorrow: {
    ...
    imgs: {
      full: {
        src: require('./one_for_sorrow_2020_web.jpg'),
        width: 796,
        height: 1000,
      },
      thumb: {
        src: require('./one_for_sorrow_2020_thumb.jpg'),
        width: 478,
        height: 600,
      },
    },
  ...
  old_nog: {
    ...
    imgs: {
      full: {
        src: require('./old_nog_2020_web.jpg'),
        width: 702,
        height: 1000,
      },
      thumb: {
        src: require('./old_nog_2020_thumb.jpg'),
        width: 421,
        height: 600,
      },
    },
  ...
  deer_in_phoenix_park: {
    ...
    prints: 'SOLD',
    ship: 'FREE_IRL',
    buyUrl: 'https://www.etsy.com/ie/listing/813712057/',
    printUrl: '',
    discount: 0,
    discountPrint: 0,
    type: 'watercolour-painting',
    story:
      'I created this quick study of a stag to practice the deer head for "The Summoning". I ended up liking the linework so much I decided to finish it as a standalone painting.<br /><br />Here in Dublin one of the city attractions is Phoenix Park, an enormous green patch in the city with forests and fields. These deer roam freely, and some of them are pretty friendly towards people (especially if you have some munchies!). They are quite small though, about the size of a pony. Still when you look at them that same grace shines from their posture that you can see with their bigger cousins.',
  },
  peacock_girls: {
    title: 'Peacock Girls',
    imgs: {
      full: {
        src: require('./peacock_girls_2020_web.jpg'),
        width: 702,
        height: 1000,
      },
      thumb: {
        src: require('./peacock_girls_2020_thumb.jpg'),
        width: 421,
        height: 600,
      },
    },
  ...
  rooster_II: {
    ...
    year: '2020',
    description:
      'Coloured pencil on paper. 210 x 297 mm ( 8.27 x 11.69 in), 2020.',
    price: 62,
    original: 'AVAILABLE',
    prints: 'SOLD',
    ship: 'FREE_IRL',
    buyUrl: 'https://www.etsy.com/ie/listing/799953144/',
    printUrl: '',
    discount: 0,
    discountPrint: 0,
    type: 'coloured-pencil-drawing',
    story:
      "Another quick practice with coloured pencils. I took the reference photo at a local farm. Whenever I visit such a place I'm always reminded how much I enjoy these simple animals. You can get me tigers, horses and all kind of majestic beasts, my all time favourites are farm birds!",
  },
};

export default imgData_2020;
